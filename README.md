...
### Exercise 1 SETUP
1. Download the exercise folder from repository.
2. Open the folder.
3. Open file index.html file with the browser.

###Unit Test case Setup:
1. Open the folder.
2. Open file unittests.html file with the browser.

### Exercise 2 SETUP:
1. Need any server setup(Wamp, Xamp, etc..) to run the exercise 2.
2. Start the server.
3. Place the exercise 2 folder within the www or respective root path of the server.
4. Open the folder which is available in the server using the browser.
